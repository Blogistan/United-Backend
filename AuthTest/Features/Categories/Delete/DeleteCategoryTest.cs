...
namespace AuthTest.Features.Categories.Delete
{
    public class DeleteCategoryTest : CategoryMockRepository, IClassFixture<Startup>
    {
        ...
        public DeleteCategoryTest(CategoryFakeData fakeData) : base(fakeData)
        {
            ...
            this.deleteCategoryCommand = new DeleteCategoryCommand();
            this.deleteCategoryCommandHandler = new DeleteCategoryCommandHandler(MockRepository.Object, categoryBusinessRules);
            this.validationRules = new DeleteCategoryValidator();
        }
        [Fact]
