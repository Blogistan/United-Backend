...
namespace AuthTest.Features.Categories.Commands.Update
{
    public class UpdateCategoryTest : CategoryMockRepository, IClassFixture<Startup>
    {
        ...
        public UpdateCategoryTest(CategoryFakeData fakeData) : base(fakeData)
        {
            ...
            updateCategoryCommandHandler = new UpdateCategoryCommandHandler(MockRepository.Object, categoryBusinessRules);
            validationRules = new UpdateCategoryValidator();
        }
        [Fact]
